...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-review-add-review-module"], {
  ...
  /***/
  function srcAppAddReviewAddReviewRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAddReviewAddReviewPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AddReviewPage = /*#__PURE__*/function () {
      function AddReviewPage(toastController) {
      ...
      _createClass(AddReviewPage, [{
        ...
        key: "toggleRatingIcon1",
        value: function toggleRatingIcon1() {
          this.ratingIcon1 = !this.ratingIcon1;
        }
      }, {
        key: "toggleRatingIcon2",
        value: function toggleRatingIcon2() {
          this.ratingIcon2 = !this.ratingIcon2;
        }
      }, {
        key: "toggleRatingIcon3",
        value: function toggleRatingIcon3() {
          this.ratingIcon3 = !this.ratingIcon3;
        }
      }, {
        key: "toggleRatingIcon4",
        value: function toggleRatingIcon4() {
          this.ratingIcon4 = !this.ratingIcon4;
        }
      }, {
        key: "toggleRatingIcon5",
        value: function toggleRatingIcon5() {
