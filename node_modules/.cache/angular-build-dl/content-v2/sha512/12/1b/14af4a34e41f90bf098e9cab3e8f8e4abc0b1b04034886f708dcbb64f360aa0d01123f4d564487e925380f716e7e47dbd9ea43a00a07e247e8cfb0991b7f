...
let SignUpPage = class SignUpPage {
    constructor(route, loadCtrl, alertCtrl, navCtrl, authService, http) {
        this.route = route;
    ...
    checkEmail(control) {
        ...
        this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].url, formData)
            .subscribe(result => {
            if (result.valid) {
